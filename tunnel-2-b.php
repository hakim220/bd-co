...
?>
	<div class="info_livraison">
		...
		<form method="post" action="">
			...
			<label for="monsieur">Monsieur</label><input id="monsieur" type="radio" name="civilite" value="monsieur" />
			...
			<label for="prenom">Prenom</label><input id="prenom" type="text" name="prenom"  value=""/>	<br/>	
			...
			<label for="adresse">Adresse</label><input id="adresse" type="text" name="adresse"  value=""/>	<br/>	
			<label for="cp">Code postal</label><input id="cp" type="text" name="code_postal"  value=""/><br/>	
			<label for="ville">Ville</label><input id="ville" type="text" name="ville"  value=""/><br/>	
			<p class="gras">Adresse de livraison</p>
			<label for="adresse_l">Adresse</label><input id="adresse_l" type="text" name="adresse_livraison"  value=""/>	<br/>	
			<label for="codepostal_l">Code postal</label><input id="codepostal_l" type="text" name="code_postal_livraison"  value=""/><br/>	
			<label for="ville_l">Ville</label><input id="ville_l" type="text" name="ville_livraison"  value=""/><br/>	
